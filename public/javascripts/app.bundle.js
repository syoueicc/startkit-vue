...
/***/ function(module, exports, __webpack_require__) {
	...
	if (__vue_script__ &&
	  ...
	  console.warn("[vue-loader] vendor\\containers\\app.vue: named exports in *.vue files are ignored.")}
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    vuex: {
	        getters: {
	            counter: _getters.getCount
	        },
	        actions: {
	            add: _actions.add, mod: _actions.mod
	        }
	    },
	    data: function data() {
	        return {
...
/***/ function(module, exports) {
	...
	var add = exports.add = function add(_ref) {
	...
	var mod = exports.mod = function mod(_ref2) {
...
/***/ function(module, exports) {
	...
	module.exports = "\n<div>count: {{counter}}</div>\n<button type=\"button\" @click=\"add\">ADD CLICK</button>\n<button type=\"button\" @click=\"mod\">MOD CLICK</button>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mutationType = __webpack_require__(30);
	...
	var mutations = (_mutations = {}, (0, _defineProperty3.default)(_mutations, _mutationType.TEST, function (state, amount) {
	    state.count++;
	}), (0, _defineProperty3.default)(_mutations, _mutationType.TESTTEST, function (state) {
	    state.count--;
	    console.log(123);
	}), _mutations);
